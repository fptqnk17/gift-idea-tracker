...
import { useNavigation, useRoute as useRouteAlias } from '@react-navigation/native';
...
const EditGiftScreen = () => {
  ...
  const pickImage = async () => {
    ...
    if (!result.canceled) {
      setImage(result.assets[0].uri); // Cập nhật ảnh vào state
    }
  };

  // Lưu thông tin quà tặng đã chỉnh sửa
          ...
          {image ? (
            <>
              ...
              <Pressable
                ...
                onPress={pickImage} // Mở màn hình chọn ảnh
              >
